...
Now that we are familiar with RSA, what can we do to decrypt the message? The wiki page states a couple of attacks against plain RSA (plain means: uses no padding mechanism)[^1]:
...
````
p: 


q:

````
...
[^fermat]: https://en.wikipedia.org/wiki/Fermat's_factorization_method
